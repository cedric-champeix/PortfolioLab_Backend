...
const getResume = async (req: Request, res: Response) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: 'Error : resume can not be fetched' });
    }
};
...
const getPortfolio = async (req: Request, res: Response) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: 'Error : projects can not be fetched' });
    }
};
...
const getProject = async (req: Request, res: Response) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: 'Error: could not fetch project' });
    }
};

export { getPortfolio, getProject, getResume };
