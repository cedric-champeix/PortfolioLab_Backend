...
import {
    connectMainImage, connectProjectImage,
    connectSkill,
    createProject, deleteProject, disconnectMainImage, disconnectProjectImage,
    disconnectSkill,
    getAllProjects,
    getProject, publish, unpublish, updateProject, updateProjectVisibility
...
projectRouter.route('/projects/:myProjectId')
